    ...
    <section>
        <header class="container mx-auto mb-4 max-w-[800px] px-6 pb-4 mt-10 text-center">
            <p class="inherits-color text-balance leading-tighter relative z-10 text-3xl font-semibold tracking-tight">
                {{__('filament-blog::blog-views.blogs.category-post.category')}}: {{ $category->name }}
            </p>
        </header>
    </section>
                ...
                @empty
                    <div class="mx-auto col-span-3">
                        <div class="flex items-center justify-center">
                            <p class="text-2xl font-semibold text-gray-300">{{__('filament-blog::blog-views.blogs.category-post.no_posts')}}</p>
                        </div>
                    </div>
                @endforelse
            </div>
