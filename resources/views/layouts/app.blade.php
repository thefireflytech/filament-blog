        ...
        <div class="container mx-auto">
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <form method="post" action="{{ route('filamentblog.post.subscribe') }}">
                                                @csrf
                                                <label hidden
                                                       for="email-address">@lang('filament-blog::layouts.email')</label>
                                                @error('email')
                                                ...
                                                <div class="w-100 relative">
                                                    <input autocomplete="email"
                                                           ...
                                                           placeholder="{{ __('filament-blog::layouts.email-placeholder') }}"
                                                           type="email">
                                                    <button type="submit"
            ...
            <div class="mt-7 flex flex-wrap items-start justify-center gap-10 border-t border-slate-200 pt-5">
                <div class="text-hurricane/50 text-sm font-medium">
                    © {{ date('Y') }} {{ $setting->organization_name ?? 'Firefly Blog' }}
                    . @lang('filament-blog::layouts.all-rights-reserved').
                </div>
            </div>
        </div>
    </footer>
