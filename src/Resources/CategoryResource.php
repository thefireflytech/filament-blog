...
class CategoryResource extends Resource
{
        ...
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('name')
                    ->label(__('filament-blog::resources/categories.tables.columns.name'))
                    ->searchable(),
                Tables\Columns\TextColumn::make('slug')
                    ->label(__('filament-blog::resources/categories.tables.columns.slug')),
                Tables\Columns\TextColumn::make('posts_count')
                    ->label(__('filament-blog::resources/categories.tables.columns.posts_count'))
                    ->badge()
                    ->counts('posts'),
    ...
    public static function infolist(Infolist $infolist): Infolist
    {
        return $infolist->schema([
            Section::make(__('filament-blog::resources/categories.title'))
                ->schema([
                    TextEntry::make('name')
    ...
    {
        return __('filament-blog::resources/categories.title');
    }

    public static function getPluralLabel() : ?string
    {
        return __('filament-blog::resources/categories.plural_title');
    }
