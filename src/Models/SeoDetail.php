...
class SeoDetail extends Model
{
    ...
    public static function getForm()
    {
        return [
            Select::make('post_id')
                ->label(__('filament-blog::resources/seo_details.forms.fields.post'))
            ...
            TextInput::make('title')
                ->label(__('filament-blog::resources/seo_details.forms.fields.title'))
                ->required()
                ->maxLength(255)
                ->columnSpanFull(),
            TagsInput::make('keywords')
                ->label(__('filament-blog::resources/seo_details.forms.fields.keywords'))
                ->columnSpanFull(),
            Textarea::make('description')
                ->label(__('filament-blog::resources/seo_details.forms.fields.description'))
                ->required()
                ->maxLength(65535)
                ->columnSpanFull(),
        ];
